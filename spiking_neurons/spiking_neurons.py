...
class LIFNeuron(object):
    """
    Neuron model from https://github.com/kaizouman/tensorsandbox/blob/master/snn/simple_spiking_model.ipynb
    Replication of the model described in  § 4.1 of "Spiking Neuron Models", by Gerstner and Kistler (2002).
    """
